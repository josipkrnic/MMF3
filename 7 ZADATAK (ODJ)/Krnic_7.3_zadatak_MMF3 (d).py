...
a,b = nj.analiticki(4)
a_4,b_4 = nj.rk4(4,0,0,7*T,2000)
a1,b1 = nj.analiticki(8)
a_8,b_8 = nj.rk4(8,0,0,7*T,2000)
a2,b2 = nj.analiticki(16)
a_16,b_16 = nj.rk4(16,0,0,7*T,2000)
a3,b3 = nj.analiticki(32)
a_32,b_32 = nj.rk4(32,0,0,7*T,2000)
a5,b5 = nj.analiticki(64)
a_64,b_64 = nj.rk4(64,0,0,7*T,2000)
plt.subplot(2,3,1)
plt.plot(a,b,c="r")
plt.plot(a_4,b_4,c="b")
plt.xlim(0,7*T)
plt.legend(["Analitički","RK4"],loc = "upper right")
plt.subplot(2,3,2)
plt.plot(a1,b1,c="r")
plt.plot(a_8,b_8,c="b")
plt.xlim(0,7*T)
plt.legend(["Analitički","RK4"],loc = "upper right")
plt.subplot(2,3,3)
plt.plot(a2,b2,c="r")
plt.plot(a_16,b_16,c="b")
plt.xlim(0,7*T)
plt.legend(["Analitički","RK4"],loc = "upper right")
plt.subplot(2,3,4)
plt.plot(a3,b3,c="r")
plt.plot(a_32,b_32,c="b")
plt.xlim(0,7*T)
plt.legend(["Analitički","RK4"],loc = "upper right")
plt.subplot(2,3,5)
plt.plot(a5,b5,c="r")
plt.plot(a_64,b_64,c="b")
plt.xlim(0,7*T)
plt.legend(["Analitički","RK4"],loc = "upper right")
plt.subplot(2,3,6)
b_ = []
