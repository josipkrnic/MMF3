...
def analiticki(y0,N=2000,l=0.2484902028828339,g=9.81):
    ...
    for i in range(1,N):
        t.append(i*0.01)
        y.append(y0*numpy.cos(w0*t[i-1]))
    return t,y
...
def euler(y0,v0,t0=0,tN=20,N=2000,l=0.2484902028828339,g=9.81,fi_0=0):
    ...
    for i in range(1,N):
        ...
        y.append(y[i-1] + v[i-1]*h) #čak je bolje uzeti v[i]*h jer daje precizniji rezultat od čistog Eulera
    y_deg = []
    for j in y:
...
def rk4(y0,v0,t0=0,tN=20,N=2000,l=0.2484902028828339,g=9.81,fi_0=0):
    ...
    return t_rk,y_rk,v_rk,y_rk_deg
